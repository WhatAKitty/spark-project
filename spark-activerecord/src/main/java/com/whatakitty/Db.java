...
public class Db {
    ...
    /**
     * @see #batch(String, String, List)
     */
    public static int[] batch(String sql, String columns, List modelOrRecordList) {
        return pro.batch(sql, columns, modelOrRecordList);
    }
