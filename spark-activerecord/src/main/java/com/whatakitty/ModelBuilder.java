...
public class ModelBuilder {
	...
	public static final <T> List<T> build(ResultSet rs, Class<? extends Model> modelClass, Callback callback) throws SQLException, InstantiationException, IllegalAccessException {
		...
		while (rs.next()) {
			...
			T t = (T)ar;
			if (callback == null || callback != null && callback.invoke(ar)) {
				result.add(t);
			}
		}
		return result;
	...
	public interface Callback {
		public boolean invoke(Model<?> model);
	}
